        ...
        "serve" => {
            ...
            std::thread::scope(|f| {
                    ...
                    loop {
                        ...
                        match input.trim().to_lowercase().as_str() {
                            "e" => {
                                ...
                                let send_message =
                                    serde_json::to_string(&vec![String::from("exec"), bundle])
                                        .unwrap();
                ...
                // Scope the watcher
                {
                    ...
                    // Create the parser
                    let mut require_visitor =
                        RequireVisitor::new(&config.src_dir, &config.entry_file);
                    ...
                    for e in rx {
                        ...
                        for file in &e.paths {
                            ...
                            if last_file_event.elapsed().unwrap().as_millis()
                                < debounce_time as u128
                            {
                                continue;
                            }
                            ...
                            let relative_file =
                                file_name[file_offset..].to_string().replace("\\", "/");
